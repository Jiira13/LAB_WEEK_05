...
import com.jimmy.lab_week_05.api.CatApiService
import com.jimmy.lab_week_05.model.ImageData
        ...
        call.enqueue(object : Callback<List<ImageData>> {
            ...
            override fun onResponse(call: Call<List<ImageData>>, response: Response<List<ImageData>>) {
                if (response.isSuccessful) {
                    ...
                    apiResponseView.text = getString(R.string.breed_info, breedName)
                } else {
